        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div className="relative overflow-hidden rounded-lg shadow-xl">
            <Image
              ...
              width={400}
              height={400}
              className="w-full h-auto object-cover transition-transform duration-300 hover:scale-105 sm:w-64 sm:h-auto md:w-80"
            />
          </div>

          <div>
            <h1 className="text-3xl sm:text-xl md:text-2xl font-bold text-yellow-400 leading-snug">
              {product.title}
            </h1>
            <p className="mt-4 text-sm sm:text-xs md:text-sm leading-relaxed text-gray-300">
              {product.description}
            </p>
            <p className="mt-6 text-xl sm:text-lg md:text-xl font-bold text-yellow-500">
